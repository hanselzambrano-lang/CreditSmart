    ...
    <main className="container">
      <section className="credits-section">
        ...
        <div className="simulator-controls">
          <input className="search-input" type="search" placeholder="Buscar por nombre de producto..." value={query} onChange={e=>setQuery(e.target.value)} />
        ...
        <div className="credits-grid">
          {filtered.length === 0 && <p className="no-results">No hay créditos disponibles según los criterios.</p>}
          {filtered.map(c=> <CreditCard key={c.id} data={c} />)}
        </div>
      </section>
    </main>
  )
